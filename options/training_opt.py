...
class TrainOptions(BaseOptions):
    ...
    def init_experiment_params(self, parser):
        ...
        parser.add_argument('--gamma', type=float, default=0.99999999, help='gamma for the lr decay')
        ...
        # Pretrained network
        parser.add_argument('--path_age_clf', type=str, default='./pretrained_models/Age_clf_Net_last_it_255400.pth', help='Path to the Age classifier.')
